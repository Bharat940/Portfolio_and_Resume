            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-end">
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-mono text-[10px] md:text-xs font-bold text-ctp-mauve uppercase tracking-[0.2em] md:tracking-[0.3em]">
                    Full Archive
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4 p-4 md:p-6 bg-ctp-surface0/30 border border-border/20 rounded-2xl md:rounded-[2rem] backdrop-blur-md">
                <div className="flex flex-col">
                  <span className="text-xl md:text-2xl font-black font-heading text-ctp-mauve">
                    {stats.total}
                  </span>
                ...
                <div className="flex flex-col">
                  <span className="text-xl md:text-2xl font-black font-heading text-ctp-sky">
                    {stats.web}
                  </span>
                  <span className="text-[8px] md:text-[10px] font-mono text-muted-foreground uppercase tracking-widest">
                    Web Systems
                ...
                <div className="flex flex-col">
                  <span className="text-xl md:text-2xl font-black font-heading text-ctp-peach">
                    {stats.native}
                  </span>
                  <span className="text-[8px] md:text-[10px] font-mono text-muted-foreground uppercase tracking-widest">
                    Native Core
                ...
                <div className="flex flex-col">
                  <span className="text-xl md:text-2xl font-black font-heading text-ctp-green">
                    {stats.uniqueTags}
                  </span>
                  <span className="text-[8px] md:text-[10px] font-mono text-muted-foreground uppercase tracking-widest">
                    Tech Stacks
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs font-mono text-muted-foreground uppercase tracking-widest">
              Distributed Frontend & Backend Architectures
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs font-mono text-muted-foreground uppercase tracking-widest">
              System Internals, C++, & Low-Level Logic
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
