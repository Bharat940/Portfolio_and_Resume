...
export function HomeContent() {
  return (
    <main className="flex flex-col min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="bg-(--section-1) relative z-0">
        <Hero />
      </div>
      ...
      <div className="bg-(--section-2) relative z-0">
        <ProjectGrid />
      </div>
      ...
      <div className="bg-(--section-3) relative z-0">
        <SkillsSection />
      </div>
      ...
      {/* Timeline — blue tint */}
      <div className="bg-(--section-4) relative z-0">
        <ExperienceTimeline />
      </div>
      ...
      {/* Activity — near-base */}
      <div className="bg-(--section-5) relative z-0">
        <ContributionGraph />
      </div>
      ...
      {/* Contact — cool tint */}
      <div className="bg-(--section-6) relative z-0">
        <ContactSection />
      </div>
    </main>
  );
