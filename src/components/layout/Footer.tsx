...
export function Footer() {
  return (
    <footer className="border-t border-border mt-auto relative overflow-hidden bg-muted/20">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="https://github.com" target="_blank" className="text-muted-foreground hover:text-ctp-lavender transition-colors p-2" title="GitHub">
            <PixelGitHub className="w-6 h-6 grayscale hover:grayscale-0 transition-all" />
          </Link>
          <Link href="https://twitter.com" target="_blank" className="text-muted-foreground hover:text-ctp-sky transition-colors p-2" title="Twitter">
            <AtSign className="w-5 h-5" />
          </Link>
          <Link href="https://linkedin.com" target="_blank" className="text-muted-foreground hover:text-ctp-blue transition-colors p-2" title="LinkedIn">
