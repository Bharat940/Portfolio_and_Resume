...
const aboutNavItems: NavItem[] = [
  { name: 'Back', href: '/', icon: <Home className="w-4 h-4" />, isSection: false },
  { name: 'Philosophy', href: '#philosophy', icon: <User className="w-4 h-4" />, isSection: true },
  { name: 'Origin', href: '#origin', icon: <PixelTerminal className="w-4 h-4" />, isSection: true },
  { name: 'CV', href: '#cv', icon: <FileText className="w-4 h-4" />, isSection: true },
];
    ...
    <main className="flex flex-col min-h-screen bg-background">
      ...
      <section id="philosophy" className="bg-[var(--section-1)] pt-32 pb-24 px-6 md:px-12 lg:px-20 relative z-0">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center gap-4 px-4 py-2 rounded-xl bg-ctp-green/10 border border-ctp-green/20 text-ctp-green font-mono text-xs uppercase tracking-widest">
              <PixelTerminal className="w-4 h-4" />
              Entity Profile: Bharat Dangi
            </div>
            <h1 className="text-4xl md:text-8xl font-black text-foreground font-heading tracking-tight leading-none uppercase">
              Technical <span className="text-ctp-green italic">Philosophy</span>
            </h1>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-4">
                  ...
                  <p className="text-sm font-mono text-ctp-green uppercase tracking-[0.3em]">Init: 2026_Core_Boot</p>
                </div>
                <div className="hidden md:flex flex-col items-end text-right">
                  <span className="text-[10px] font-mono text-muted-foreground uppercase">Authorization</span>
                  <span className="text-xs font-mono font-bold text-foreground">Level_04_Architect</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    My engineering journey is defined by a relentless curiosity for system internals. From implementing
                    <span className="text-foreground font-bold"> anti-aliasing and light scattering</span> in a custom
                    CPU-based Ray Tracer to engineering <span className="text-foreground font-bold">fault-tolerant async processing</span>
                    at scale, I view every project as a distributed puzzle.
                  </p>
                </div>
                <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    I thrive in the space where <span className="text-ctp-blue italic">concurrency meets consistency</span>.
                    My focus remains on designing systems that are not just visually stunning, but mathematically sound and production-ready.
                  </p>
                </div>
              </div>

              {/* Integrated Base_Ops & Sync_Links */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pt-12 border-t border-border/20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest">Base_Ops</span>
                  </div>
                  <p className="text-xl font-bold">Bhopal, India</p>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-ctp-green animate-pulse" />
                    <span className="text-[10px] font-mono text-ctp-green uppercase font-bold tracking-widest">Active_Available</span>
                  </div>
                </div>
                ...
                <div className="md:col-span-2 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest">Sync_Links</span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <a href="https://github.com/Bharat940" target="_blank" className="group flex items-center gap-3 p-4 bg-ctp-surface0/30 border border-border/30 rounded-2xl hover:bg-ctp-surface1 transition-all">
                    ...
                    <a href="https://linkedin.com/in/bharat-dangi-b186b3248" target="_blank" className="group flex items-center gap-3 p-4 bg-ctp-surface0/30 border border-border/30 rounded-2xl hover:bg-ctp-surface1 transition-all">
                    ...
                    <a href="mailto:bdangi450@gmail.com" className="group flex items-center gap-3 p-4 bg-ctp-surface0/30 border border-border/30 rounded-2xl hover:bg-ctp-surface1 transition-all">
                      <Mail className="w-4 h-4 text-ctp-peach" />
                      <span className="text-[10px] font-bold font-mono italic truncate">bdangi450@gmail.com</span>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div id="cv" className="relative z-0">
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
                  <div>
                    <h2 className="text-3xl font-black font-heading tracking-tight mb-2 uppercase">Curriculum Vitae</h2>
                    <p className="text-sm font-mono text-muted-foreground uppercase tracking-widest">Distributed Core</p>
                  </div>
                  <a
                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-8">
                      <div className="relative pl-6 border-l-2 border-border/30">
                        ...
                        <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                          ...
                          <li>Improved UI/UX in collaboration with design and engineering teams.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Education Block */}
                  <div className="space-y-6">
                    <h3 className="text-xs font-mono text-ctp-blue uppercase tracking-[0.4em] border-b border-ctp-blue/20 pb-2">02_Education</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-1">
                        <h4 className="font-bold">B.Tech in Information Technology</h4>
                        <p className="text-xs text-muted-foreground uppercase">UIT RGPV · 2024 - 2028</p>
                        <p className="text-sm text-ctp-blue font-mono mt-2">CGPA: 7.94 / 10</p>
                      </div>
                      <div className="space-y-1">
                        <h4 className="font-bold">High School Diploma (PCM)</h4>
                        <p className="text-xs text-muted-foreground uppercase">Deepmala Pagarani School</p>
                        <p className="text-sm text-ctp-blue font-mono mt-2">Score: 91.6%</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <h3 className="text-xs font-mono text-ctp-mauve uppercase tracking-[0.4em] border-b border-ctp-mauve/20 pb-2">03_Stack_Overflow</h3>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                      {skillsWithLogos.map((skill) => (
                        <div key={skill.name} className="flex flex-col items-center p-4 bg-ctp-surface0/50 border border-border/30 rounded-xl hover:border-ctp-mauve/50 transition-colors group">
